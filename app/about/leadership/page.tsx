          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: 20 }}>
            {leaders.map((p, i) => (
              <Reveal key={p.name} delay={(i % 4) * 0.05} style={{ background: "rgba(255,255,255,.04)", border: "1px solid rgba(255,255,255,.08)", borderRadius: 12, padding: 30, textAlign: "center" }}>
                <div style={{ width: 104, height: 104, borderRadius: "50%", margin: "0 auto 18px", overflow: "hidden", background: "linear-gradient(135deg,#2E6BE6,#1c3f8f)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "var(--font-archivo)", fontWeight: 800, fontSize: 30, color: "#fff", boxShadow: "0 0 0 3px rgba(46,107,230,.35)" }}>
                  {p.image ? (
                    // eslint-disable-next-line @next/next/no-img-element
