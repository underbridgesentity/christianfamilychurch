  ...
  return (
    <main style={{ width: "100%", overflowX: "hidden", color: "var(--ink)", background: "#fff" }}>
      ...
      <HeroVideo src="/assets/hero.mp4" poster="/assets/welcome-banner.jpg">
        <h1 style={{ fontFamily: "var(--font-archivo)", fontWeight: 900, fontSize: "clamp(34px,6.6vw,88px)", lineHeight: 1.02, letterSpacing: "-.03em", color: "#fff", margin: "0 0 22px" }}>
        ...
        <p style={{ fontSize: "clamp(18px,2.1vw,24px)", fontWeight: 300, lineHeight: 1.55, color: "rgba(255,255,255,.84)", maxWidth: 840, margin: "0 auto 38px" }}>
          A church for everyone, across Johannesburg.<br className="hero-br" />
          {" "}Whoever you are, wherever you’ve been -<br className="hero-br" />
